...
- 支持连接设置、刷新频率、登录启动、界面语言、自动检查更新、外观模式和配色方案。
...
| 连接设置 | 通用设置 |
| --- | --- |
| <img src="docs/assets/readme/settings-connection.jpg" alt="Moonraker 连接设置" width="420"> | <img src="docs/assets/readme/settings-general.jpg" alt="语言、刷新频率、登录启动和更新检查设置" width="420"> |
