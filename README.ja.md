...
- 接続、更新間隔、ログイン時起動、インターフェイス言語、自動アップデート確認、外観モード、カラーパレットを設定可能。
...
| 接続設定 | 一般設定 |
| --- | --- |
| <img src="docs/assets/readme/settings-connection.jpg" alt="Moonraker 接続設定" width="420"> | <img src="docs/assets/readme/settings-general.jpg" alt="言語、更新間隔、ログイン時起動、アップデート確認の設定" width="420"> |
